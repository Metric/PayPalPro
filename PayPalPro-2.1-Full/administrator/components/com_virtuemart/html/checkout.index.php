...
$paypal_express_checkout = vmGet($_REQUEST, 'ppex', 0);
$paypal_express_checkout_payment = vmGet($_REQUEST, 'payment_method_ppex', 0);
$paypal_express_checkout_cancel = vmGet($_REQUEST, 'ppex_cancel',0);
if((int)$paypal_express_checkout_cancel > 0) {
...
if((int)$paypal_express_checkout == 1) {
...
else if((int)$paypal_express_checkout_payment == 2)
{
...
$paypal_express_checkout = vmGet($_REQUEST, 'ppex_gecd', 0);
